...
function () {
    ...
    ]).controller("SubmitCtrl", ["$scope", "logger",
        function ($scope, logger) {
            return $scope.notify = function (type, msg) {
                switch (type) {
                case "info":
    ...
    angular.module("app.directives", []).directive("imgHolder", [
        ...
        function () {
            return {
                restrict: "A",
                link: function (scope, ele) {
                    return console.log("nice"), ele.niceScroll({
                        cursorcolor: "#31C0BE",
                        cursorborder: "0",
