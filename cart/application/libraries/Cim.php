...
//Load shared Authorize.net libraries
$sdkpath = APPPATH . "/libraries/authnetsdk/";

require $sdkpath."AuthorizeNetRequest.php";
require $sdkpath."AuthorizeNetException.php";
require $sdkpath."AuthorizeNetResponse.php";
require $sdkpath."AuthorizeNetTypes.php";
require $sdkpath."AuthorizeNetXMLResponse.php";
require $sdkpath."AuthorizeNetAIM.php";

class Cim extends AuthorizeNetRequest
{
    ...
    public function __construct()
    {
        ...
        parent::__construct($this->CI->config->item("anet_api_id"), $this->CI->config->item("anet_transaction_key"));
        $sandbox = ($this->CI->config->item("anet_sandbox")) ? true : false;
    ...
    private function _constructXml($request_type)
    {
        ...
        $this->_xml = @new SimpleXMLElement('<' . $request_type . '/>');
