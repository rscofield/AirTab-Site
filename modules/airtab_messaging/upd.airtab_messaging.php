...
/**
 * AirTab Messaging Module Install/Update File
 *
 * @package		ExpressionEngine
 * @subpackage	Addons
 * @category	Module
...
class Airtab_messaging_upd {
    ...
    */
	...
	public function uninstall()
	{
		...
		$this->EE->db->where('module_name', 'Airtab_messaging')
					 ->delete('modules');
    ...
    {
        ee()->db->where('class', "Airtab_messaging");
...
/* End of file upd.airtab_messaging.php */
/* Location: /system/expressionengine/third_party/airtab/upd.airtab_messaging.php */